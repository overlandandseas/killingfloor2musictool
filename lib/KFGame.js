...
class KFGame {
  ...
  findDefaultPath() {
    ...
    this.PATH = "C:\\Program Files (x86)\\Steam\\steamapps\\common\\killingfloor2\\KFGame\\BrewedPC\\WwiseAudio\\Windows"
  ...
  checkPath(checkMe) {
    ...
    try {
      fs.lstatSync(`${folderName}\\KFGame\\BrewedPC\\WwiseAudio\\Windows`)
      this.PATH = `${folderName}\\KFGame\\BrewedPC\\WwiseAudio\\Windows`
    } catch (err) {
